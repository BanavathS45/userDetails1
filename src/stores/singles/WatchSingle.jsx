      ...
      <div className="row ">
        <div className="col-3 imgCard  ">
          ...
          <div className="smallImg">
            <div className="row">
              <div className="col"> <img src={watchData[1].image} alt="" /></div>
              <div className="col"> <img src={watchData[2].image} alt="" /></div>
              <div className="col"> <img src={watchData[3].image} alt="" /></div>
              <div className="col"> <img src={watchData[4].image} alt="" /></div>
            </div>
          </div>
        </div>
