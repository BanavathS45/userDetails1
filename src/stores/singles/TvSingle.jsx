...
const TvSingle = () => {
  ...
  const {id}=useParams();
  const products=tvData.find((item)=>item.id===id)
      ...
      <div className="row ">
        <div className="col-3 imgCard  ">
          ...
          <div className="smallImg">
            <div className="row">
              <div className="col"> <img src={tvData[1].image} alt="" /></div>
              <div className="col"> <img src={tvData[2].image} alt="" /></div>
              <div className="col"> <img src={tvData[3].image} alt="" /></div>
              <div className="col"> <img src={tvData[4].image} alt="" /></div>
            </div>
          </div>
        </div>
