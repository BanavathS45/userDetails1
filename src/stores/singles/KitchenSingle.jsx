      ...
      <div className="row ">
        <div className="col-3 imgCard  ">
          ...
          <div className="smallImg">
            <div className="row">
              <div className="col"> <img src={kitchenData[1].image} alt="" /></div>
              <div className="col"> <img src={kitchenData[2].image} alt="" /></div>
              <div className="col"> <img src={kitchenData[3].image} alt="" /></div>
              <div className="col"> <img src={kitchenData[4].image} alt="" /></div>
            </div>
          </div>
        </div>
