    ...
    <div className="singleCard">
      ...
      <div className="row ">
        <div className="col-3 imgCard ">
          ...
          <div className="smallImg mt-2">
            <div className="row">
              <div className="col"> <img src={menData[1].image} alt="" /></div>
              <div className="col"> <img src={menData[2].image} alt="" /></div>
              <div className="col"> <img src={menData[3].image} alt="" /></div>
              <div className="col"> <img src={menData[4].image} alt="" /></div>
            </div>
          </div>
        </div>
