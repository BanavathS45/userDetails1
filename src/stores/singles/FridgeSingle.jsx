      ...
      <div className="row ">
        <div className="col-3 imgCard  ">
          ...
          <div className="smallImg">
            <div className="row">
              <div className="col"> <img src={fridgeData[1].image} alt="" /></div>
              <div className="col"> <img src={fridgeData[2].image} alt="" /></div>
              <div className="col"> <img src={fridgeData[3].image} alt="" /></div>
              <div className="col"> <img src={fridgeData[4].image} alt="" /></div>
            </div>
          </div>
        </div>
