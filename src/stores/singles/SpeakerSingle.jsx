...
const SpeakerSingle = () => {
    ...
    const {id}=useParams();
    const products=speakerData.find((item)=>item.id===id)
  ...
  <div className="row ">
    <div className="col-3 imgCard  ">
      ...
      <div className="smallImg">
        <div className="row">
          <Link className="col"> <img src={speakerData[0].image} alt="" /></Link>
          <Link className="col"> <img src={speakerData[1].image} alt="" /></Link>
          <Link className="col"> <img src={speakerData[2].image} alt="" /></Link>
          <Link className="col"> <img src={speakerData[3].image} alt="" /></Link>
        </div>
      </div>
    </div>
